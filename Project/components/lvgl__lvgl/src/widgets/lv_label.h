...
enum {
    LV_LABEL_LONG_WRAP,             /**< 保持对象宽度，将过长的行换行并扩展对象高度 */
    LV_LABEL_LONG_DOT,              /**< 保持对象大小，如果文本太长，在末尾写入省略号 */
    LV_LABEL_LONG_SCROLL,           /**< 保持对象大小，文本来回滚动 */
    LV_LABEL_LONG_SCROLL_CIRCULAR,  /**< 保持对象大小，文本循环滚动 */
    LV_LABEL_LONG_CLIP,             /**< 保持对象大小，剪切掉超出部分的文本 */
};

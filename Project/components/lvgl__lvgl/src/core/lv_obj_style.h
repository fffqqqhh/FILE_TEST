...
typedef enum {
    _LV_STYLE_STATE_CMP_SAME,           /**< 两种状态下的样式属性是相同的 */
    _LV_STYLE_STATE_CMP_DIFF_REDRAW,    /**< 差异可以通过简单重绘显示 */
    _LV_STYLE_STATE_CMP_DIFF_DRAW_PAD,  /**< 差异可以通过简单重绘显示 */
    _LV_STYLE_STATE_CMP_DIFF_LAYOUT,    /**< 差异可以通过简单重绘显示 */

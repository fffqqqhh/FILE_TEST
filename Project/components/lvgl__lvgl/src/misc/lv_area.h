...
enum {
    ...
    LV_ALIGN_LEFT_MID,        /**< 中间左侧对齐 */
    LV_ALIGN_RIGHT_MID,       /**< 中间右侧对齐 */
    ...
    LV_ALIGN_OUT_LEFT_TOP,    /**< 外部左上对齐 */
    LV_ALIGN_OUT_LEFT_MID,    /**< 外部左中对齐 */
    LV_ALIGN_OUT_LEFT_BOTTOM, /**< 外部左下对齐 */
    LV_ALIGN_OUT_RIGHT_TOP,   /**< 外部右上对齐 */
    LV_ALIGN_OUT_RIGHT_MID,   /**< 外部右中对齐 */
    LV_ALIGN_OUT_RIGHT_BOTTOM,/**< 外部右下对齐 */
};

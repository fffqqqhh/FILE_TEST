 ...
 *  GLOBAL VARIABLES
 **********************/
uint16_t LV_LAYOUT_FLEX;                       /**< 灵活布局 */
lv_style_prop_t LV_STYLE_FLEX_FLOW;            /**< 灵活布局的流动方向 */
lv_style_prop_t LV_STYLE_FLEX_MAIN_PLACE;      /**< 主轴上的排列方式 */
lv_style_prop_t LV_STYLE_FLEX_CROSS_PLACE;     /**< 交叉轴上的排列方式 */
lv_style_prop_t LV_STYLE_FLEX_TRACK_PLACE;     /**< 轨道上的排列方式 */
lv_style_prop_t LV_STYLE_FLEX_GROW;            /**< 子项目在可用空间中增长的比例 */

...
typedef enum {
    LV_FLEX_ALIGN_START,         // 对齐到起始位置
    LV_FLEX_ALIGN_END,           // 对齐到结束位置
    LV_FLEX_ALIGN_CENTER,        // 居中对齐
    LV_FLEX_ALIGN_SPACE_EVENLY,  // 均匀分布，包括两端
    LV_FLEX_ALIGN_SPACE_AROUND,  // 均匀分布，两端留一半空间
    LV_FLEX_ALIGN_SPACE_BETWEEN, // 均匀分布，两端不留空间
} lv_flex_align_t;

typedef enum {
    LV_FLEX_FLOW_ROW                 = 0x00,                                     /**< 水平排列 */
    LV_FLEX_FLOW_COLUMN              = _LV_FLEX_COLUMN,                          /**< 垂直排列 */
    LV_FLEX_FLOW_ROW_WRAP            = LV_FLEX_FLOW_ROW | _LV_FLEX_WRAP,         /**< 水平排列并换行 */
    LV_FLEX_FLOW_ROW_REVERSE         = LV_FLEX_FLOW_ROW | _LV_FLEX_REVERSE,      /**< 水平反向排列 */
    LV_FLEX_FLOW_ROW_WRAP_REVERSE    = LV_FLEX_FLOW_ROW | _LV_FLEX_WRAP | _LV_FLEX_REVERSE, /**< 水平反向排列并换行 */
    LV_FLEX_FLOW_COLUMN_WRAP         = LV_FLEX_FLOW_COLUMN | _LV_FLEX_WRAP,      /**< 垂直排列并换行 */
    LV_FLEX_FLOW_COLUMN_REVERSE      = LV_FLEX_FLOW_COLUMN | _LV_FLEX_REVERSE,   /**< 垂直反向排列 */
    LV_FLEX_FLOW_COLUMN_WRAP_REVERSE = LV_FLEX_FLOW_COLUMN | _LV_FLEX_WRAP | _LV_FLEX_REVERSE, /**< 垂直反向排列并换行 */
} lv_flex_flow_t;

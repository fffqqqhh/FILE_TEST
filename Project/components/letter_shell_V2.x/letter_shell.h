...
/**< 版本号 */
#define     SHELL_VERSION               "1.1.0(208)"                 // 基于原本的shell2.0.8版本进行修改
...
// 以下键值来自MobaXterm
//#define     SHELL_KEY_CTRL_1            xxx        // 无键值
#define     SHELL_KEY_CTRL_2            0xFF
#define     SHELL_KEY_CTRL_3            0x1B
#define     SHELL_KEY_CTRL_4            0x1C
#define     SHELL_KEY_CTRL_5            0x1D
#define     SHELL_KEY_CTRL_6            0x1E
#define     SHELL_KEY_CTRL_7            0x1F
#define     SHELL_KEY_CTRL_8            0x7F
//#define     SHELL_KEY_CTRL_9            xxx        // 无键值
//#define     SHELL_KEY_CTRL_0            xxx        // 无键值
#define     SHELL_KEY_CTRL_TWO          0X03        // 双击CTRL

/**
 * @brief shell变量类型定义
 * 
 */
#define     SHELL_VAR_INT               0       // 32bit
#define     SHELL_VAR_SHORT             1       // 16bit
#define     SHELL_VAR_CHAR              2       // 8bit
#define     SHELL_VAR_POINTER           3       // 指针
#define     SHELL_VAL                   4       // 
 ...
 * 
 */
typedef void (*keyFunction)(SHELL_TypeDef *);
...
typedef struct
{
    const char *hint;                                           /**< 按键反馈提示 */
    unsigned char keyCode;                                      /**< shell按键键值 */
    keyFunction function;                                       /**< 按键响应函数 */
...
#if 0
// 默认命令表
extern const SHELL_CommandTypeDef shellDefaultCommandList[];
// 默认变量表
extern const SHELL_VaribaleTypeDef shellDefaultVariableList[];
#endif
